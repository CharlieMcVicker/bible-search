...
class TestBibleSearch(unittest.TestCase):
    ...
    def populate_data(self):
        ...
        Verse.create(chapter=ch3, number=16, text="For God so loved the world, that he gave his only begotten Son...")
        Verse.create(chapter=ch3, number=17, text="For God sent not his Son into the world to condemn the world...")
        ...
        Verse.create(chapter=gen1, number=2, text="And the earth was without form, and void...")
        Verse.create(chapter=gen1, number=3, text="And God said, Let there be light: and there was light.")
        
        # Add 1 Peter 5:7
        pet = Book.create(name="1 Peter")
        pet5 = Chapter.create(book=pet, number=5)
        Verse.create(chapter=pet5, number=7, text="Casting all your care upon him; for he careth for you.")
